...
- **~~Expand support for older JDKs~~**: Lowered bytecode target from JDK 21 to JDK 17. The plugin still requires Gradle 9.x (which needs JDK 17+) but now works for projects targeting JDK 17. Further lowering to JDK 11 would require Gradle 8.x support.

...
object AgentHelpText {
    ...
    private fun generateInstall(tool: BuildTool): String = buildString {
        ...
        appendLine("To find callers: ${u("find-callers", p("pattern", "methodName"))}")
    ...
    private fun generateCompact(tool: BuildTool): String = buildString {
        ...
        appendLine("  Complete reference list: imports, field types, method params, return types, casts.")
        appendLine("  Add ${p("group-by", "file")} for a one-line-per-file summary when the list is long (common for data classes).")

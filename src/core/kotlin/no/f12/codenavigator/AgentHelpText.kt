...
object AgentHelpText {
    ...
    private fun generateWorkflow(tool: BuildTool): String = buildString {
        ...
        appendLine()
        appendLine("14. STRING CONSTANTS: Find hardcoded strings in compiled code")
        ...
        appendLine()
        appendLine("15. ANNOTATIONS: Find classes and methods by annotation")
        ...
        appendLine()
        appendLine("16. IMPACT: See what's affected by recent changes")

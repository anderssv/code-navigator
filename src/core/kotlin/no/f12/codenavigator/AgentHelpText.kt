...
object AgentHelpText {
    fun generate(tool: BuildTool = BuildTool.GRADLE): String = buildString {
        ...
        appendLine("   ${u("complexity", p("classname", "\"domain\\\\..*\""), p("projectonly", "false"))} # include external")
        appendLine()
        ...
        appendLine("  ${t("cycles")}                Cycle detection (Tarjan)    [${p("root-package", "<pkg>")}] [${p("depth", "N")}]")
        ...
        appendLine("  ${t("complexity")}            Class fan-in/fan-out        ${p("classname", "<pattern>")} [${p("projectonly", "true")}] [${p("detail", "true")}]")
        ...
        appendLine("  ${p("classname", "<pattern>")}         Class name regex to analyze (${t("complexity")})")

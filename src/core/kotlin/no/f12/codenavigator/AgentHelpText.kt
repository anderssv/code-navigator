...
object AgentHelpText {
    ...
    private fun generateWorkflow(tool: BuildTool): String = buildString {
        ...
        appendLine("   ${u("dead", p("framework", "spring"))}           # auto-exclude common Spring annotations")
        appendLine()
        ...
        appendLine()
        appendLine("12. STRING CONSTANTS: Find hardcoded strings in bytecode")
    ...
    private fun generateInterpretation(tool: BuildTool): String = buildString {
        ...
        appendLine("- Use ${p("framework", "spring")} to auto-exclude common framework annotations (Spring, etc.).")

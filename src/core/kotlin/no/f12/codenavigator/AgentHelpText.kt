...
object AgentHelpText {
    ...
    private fun generateWorkflow(tool: BuildTool): String = buildString {
        ...
        appendLine()
        appendLine("15. STRING CONSTANTS: Find hardcoded strings in compiled code")
        ...
        appendLine()
        appendLine("16. ANNOTATIONS: Find classes and methods by annotation")
        ...
        appendLine()
        appendLine("17. IMPACT: See what's affected by recent changes")

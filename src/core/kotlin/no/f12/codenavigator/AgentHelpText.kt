...
object AgentHelpText {
    ...
    private fun generateInstall(tool: BuildTool): String = buildString {
        ...
        appendLine("- To move a class: ${u("move-class", p("from", "com.example.Old"), p("to", "com.example.New"))} (rewrites package decl, all imports, same-package refs)")
        ...
        appendLine()
        appendLine("Do not manually edit imports after moving/renaming a class — use ${t("move-class")}/${t("rename-method")}")
    ...
    private fun generateCompact(tool: BuildTool): String = buildString {
        ...
        appendLine()
        appendLine("IMPORTANT: Always use code-navigator instead of grep/ripgrep for finding references.")
        appendLine("cnav analyzes compiled bytecode and catches implicit same-package references,")

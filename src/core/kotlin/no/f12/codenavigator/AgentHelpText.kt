...
object AgentHelpText {
    fun generate(tool: BuildTool = BuildTool.GRADLE): String = buildString {
        ...
        appendLine("   ${u("find-usages", p("owner", "kotlinx.datetime.LocalDate"), p("method", "getMonthNumber"))}")
        ...
        appendLine("  ${t("find-usages")}             Find external API usages    ${p("owner", "<class>")} [${p("method", "<name>")}] or ${p("type", "<class>")}")
        appendLine()
        ...
        appendLine("  ${p("owner", "<class>")}           FQN of type to find usages of (${t("find-usages")})")

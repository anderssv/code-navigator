...
object AgentHelpText {
    ...
    private fun generateInstall(tool: BuildTool): String = buildString {
        ...
        appendLine()
        appendLine("NEVER use grep, ripgrep, or Glob to find type/method/field references in this project.")
        appendLine("ALWAYS use cnav commands instead — bytecode analysis is complete and catches implicit")
        ...
        appendLine()
        appendLine("To move a class: ${u("move-class", p("from", "com.example.Old"), p("to", "com.example.New"))}")
        appendLine("To rename a method: ${u("rename-method", p("target-class", "com.example.Service"), p("method", "old"), p("new-name", "new"))}")
        appendLine("To find references: ${u("find-usages", p("type", "ClassName"))}")
        appendLine("To find callers (full call hierarchy): ${u("find-callers", p("pattern", "methodName"))}")
        appendLine("To find implementations: ${u("find-interfaces", p("pattern", "InterfaceName"))}")
        appendLine("To assess change impact: ${u("changed-since", p("ref", "main"))}")
        appendLine("To understand package deps: ${t("package-deps")} or ${t("dsm")}")
        appendLine()

...
object ReportFormatter {
    ...
    fun format(data: ReportData): String {
        ...
        sections += "## Rings\n\n${HexRingFormatter.format(data.rings, no.f12.codenavigator.config.OutputFormat.TEXT)}"
    ...
    fun formatJson(data: ReportData): String = jsonObject(
        ...
        "rings" to JsonRaw(HexRingFormatter.format(data.rings, no.f12.codenavigator.config.OutputFormat.JSON)),
    ...
    fun formatLlm(data: ReportData): String {
        ...
        sections += "# rings\n${HexRingFormatter.format(data.rings, no.f12.codenavigator.config.OutputFormat.LLM)}"
